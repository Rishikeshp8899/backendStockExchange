...
public class requestDto implements Serializable{
	...
	public requestDto(String company_name, String company_email, String password, long contact_no, String location,
			long turnover_no_1, long turnover_no_2, long turnover_no_3, long turnover_no_4, long turnover_no_5) {
		super();
		this.company_name = company_name;
		this.company_email = company_email;
		this.password = password;
